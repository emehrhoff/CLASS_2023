...
# remove rep from coniditon before doing rest
...
```{r PCA analysis}
# how similar are samples and replicates
#PC1 wahat is teh biggest difference between data
# never needed past 2
...
res <- results(dds, name = "condition_homo_sapiens_cytosolic_fraction_vs_homo_sapiens_nuclear_fraction") # could run for loop for mutliple conditons 
...
stringent_just_nuc_cyto_counts_sig <-  stringent_nuc_cyto_counts_filtered[, samplesheet_nuc_cyto$sample_name]
