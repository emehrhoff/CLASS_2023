...
#SBATCH --mail-user=erme3555@colorado.edu
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --mem=6gb
...
-resume \
-profile singularity \
--reads '/scratch/Shares/rinnclass/CLASS_2023/erm3555/CLASS_2023/CLASSES/05_R_analyses/05_RNAseq/00_RNAseq_download_NF_core_pipeline/fastq/*{_read1,_read2}.fastq.gz' \
